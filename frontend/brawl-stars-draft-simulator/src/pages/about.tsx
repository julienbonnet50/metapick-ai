...
import { Info, BarChart, Wrench, User, Mail, Heart, DatabaseZap } from "lucide-react";
          ...
          <div className="card bg-base-100 shadow-lg">
            <div className="card-body">
              <div className="flex items-center mb-4">
                ...
                <h2 className="card-title ml-3">The Creator</h2>
              </div>
          ...
          <div className="card bg-base-100 shadow-lg">
            <div className="card-body">
              <div className="flex items-center mb-4">
                ...
                <h2 className="card-title ml-3">Data-Driven Design</h2>
              </div>
              <p className="text-base-content/70">
          ...
          <div className="card bg-base-100 shadow-lg">
            <div className="card-body">
              <div className="flex items-center mb-4">
                ...
                <h2 className="card-title ml-3">How It Works</h2>
              </div>
              <p className="text-base-content/70">
          ...
          <div className="card bg-base-100 shadow-lg">
            <div className="card-body">
              <div className="flex items-center mb-4">
                ...
                <h2 className="card-title ml-3">Get In Touch</h2>
              </div>
        ...
        <div className="card bg-base-100 shadow-lg mb-16">
          <div className="card-body">
            <div className="flex items-center mb-4">
              ...
              <h2 className="card-title ml-3">About This Project</h2>
            </div>
            <p className="text-base-content/70">
