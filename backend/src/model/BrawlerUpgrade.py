class BrawlerUpgrade:
    ...
    def calculate_upgrade_cost(self):
        ...
        star_power_count = 1 if len(self.star_powers) < 1 else 0  # Need 1 SP if missing.
    ...
    def print_upgrade_cost(self):
        ...
        print(f"{self.name} (lvl. {self.current_power}) || Total Power Points: {total_power_points} ----- Total Coins: {total_coins:.2f}")
