...
data_path = os.path.join(
    BASE_DIR, "data", "model", f"version_{version}", "mappings.pkl"
)
model_path = os.path.join(
    BASE_DIR, "data", "model", f"version_{version}", "nn_model_all.pth"
)


neuralNetworkService = NeuralNetworkService.NeuralNetworkService(
    data_path=data_path, model_path=model_path, version=version, appConfig=appConfig
)
...
print(
    ...
    mapName,
    ":",
    neuralNetworkService.predict_best_brawler(
...
print(
    "Winrate predicted for",
    mapName,
    ":",
    neuralNetworkService.predict_winrate(
        friends=friend_brawlers, enemies=enemy_brawlers, map_name=mapName
    ),
)
